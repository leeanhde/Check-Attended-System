...
public class SessionDBContext extends DBContext<Session> {
    ...
    public void update(Session model) {
        ...
        try {
            ...
            PreparedStatement stm_dele = connection.prepareStatement(sql);
            stm_dele.setInt(1, model.getId());
            stm_dele.executeUpdate();

            for (Attandance attandance : model.getAtts()) {
                ...
                stm_insert.setInt(2, attandance.getStudent().getId());
                stm_insert.setBoolean(3, attandance.isPresent());
                stm_insert.setString(4, attandance.getDescription());
